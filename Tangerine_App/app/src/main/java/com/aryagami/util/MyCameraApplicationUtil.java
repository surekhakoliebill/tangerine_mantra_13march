...
public class MyCameraApplicationUtil extends Activity {
    ...
    public static Uri getOutputMediaFileUri(String documentName, int type, Context mContext){
     ...
     // return Uri.fromFile(f);
        ...
        return   FileProvider.getUriForFile(
                mContext,
                "com.tangerine.android.provider", //(use your app signature + ".provider" )
                f);
    ...
    public static Bitmap getThumbnailFromImage(String imageFile, int requiredWidth, int requiredHeight) {
        try {
            ...
            int rotateAngle =  0;//getCameraPhotoOrientation(path);
        ...
        if(inputFiles.size() != 0) {
            try {
                ...
                for (String s : inputFiles) {
                    ...
                    Image image = Image.getInstance(folder.getAbsolutePath() + "/" + s);
