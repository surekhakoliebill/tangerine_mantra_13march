...
/**
 * Created by aryagami on 23/12/15.
 */
public class GcmClientManager {
    ...
    public String registerIfNeeded(Context context) throws  IOException{
     ...
     * shared preferences.
     */
    private String registerInBackground() throws IOException {
