...
import com.aryagami.tangerine.activities.CacheImageLoader;
import com.aryagami.tangerine.activities.ImageGridViewActivity;
...
public class ImageAdapter extends BaseAdapter {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
       ...
       /* grid.findViewById(R.id.checkBox1).setOnClickListener(new View.OnClickListener() {
        ...
        /*CheckBox selectCheckBox= grid.findViewById(R.id.checkBox1);
