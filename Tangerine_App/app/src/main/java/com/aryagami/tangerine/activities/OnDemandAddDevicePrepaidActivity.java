...
public class OnDemandAddDevicePrepaidActivity extends AppCompatActivity {
    ...
    View currentview;
    //DeviceContainer currentDeviceContainer = new DeviceContainer();
            ...
            public void onClick(View view) {
                ...
                deleteAddress.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        for (OnDemandAddDevicePrepaidActivity.DeviceContainer subContainer : deviceContainersList) {
                            if (subContainer.container == layout) {
                                ...
                                deviceContainersList.remove(subContainer);
                                  ...
                                  // MyToast.makeMyToast(activity,mapProductListing.size()+" IMEI "+imei,Toast.LENGTH_SHORT);
                                break;
                            }
                        }
                ...
                final OnDemandAddDevicePrepaidActivity.DeviceContainer sContainer = new OnDemandAddDevicePrepaidActivity.DeviceContainer();
                sContainer.container = layout;
                deviceContainersList.add(sContainer);
               // currentDeviceContainer = sContainer;
            }
        });
