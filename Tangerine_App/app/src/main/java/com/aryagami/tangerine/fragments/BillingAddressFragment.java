...
public class BillingAddressFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        final View view = inflater.inflate(R.layout.fragment_billing_address, container, false);
        ...
        btnsave.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(data != null) {
                    RegistrationData.setRegistrationData(data);
        ...
        addMoreAddressButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                final View layout = layoutInflater.inflate(R.layout.item_new_address_container, addressContainer, false);
                ...
                deleteAddress.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        for (BillingAddressFragment.AddressContainer subContainer : addressContainersList) {
                ...
                final BillingAddressFragment.AddressContainer sContainer = new BillingAddressFragment.AddressContainer();
    ...
    private UserRegistration.UserAddressCommand getAllAddressContainersDetails(AddressContainer subContainer) {
